...
namespace lve
{
    ...
    std::vector<char> LvePipeline::readFile(const std::string &filepath)
    {
        ...
        std::ifstream file{filepath, std::ios::ate | std::ios::binary}; // ate sends us to the end of the file
        ...
        size_t fileSize = static_cast<size_t>(file.tellg()); // since we're at eof we can get size
