...
namespace lve
{
    ...
    public:
        ...
        void copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, uint32_t layerCount) { copyBufferToImage(buffer, image, width, height, layerCount, commandPool); }
