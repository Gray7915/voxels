...
namespace lve
{
    ...
    public:
        ...
        static void emitCustomModel(std::vector<Vertex> &vertices, std::vector<uint32_t> &indices, glm::ivec3 pos, int blocks[18][128][18], glm::vec3 worldOffset, int blockType);
