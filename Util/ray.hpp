    ...
    public:
        ...
        glm::vec3 detectBlockHit(float max_distance)
        {
            ...
            for (int steps = 0; steps < 64; ++steps)
            {
                ...
                {
                    int x = (pos.x % 16 + 16) % 16;
                    int y = (pos.y % 32 + 32) % 32;
                    int z = (pos.z % 16 + 16) % 16;

                    voxel = it->second->blocks[x][y][z];
                }
                ...
                if (tmax.x > max_distance && tmax.y > max_distance && tmax.z > max_distance)
                    break;
            }
